...
def class_factory(class_name: str) -> type:
    class NewClass:
        pass
...
class Deserializer:
    ...
    def deserialize(cls, serialized_object: SerializedObject) -> Any:
        type_handler: dict[str | None, None | Callable[..., Any]] = {
            ...
            "ColouredEnum": cls.deserialize_enum,
    ...
    def deserialize_enum(
        ...
        return enum.Enum(serialized_object["name"], serialized_object["enum"])[  # type: ignore
